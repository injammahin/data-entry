...
<style>
    ...
    .type-card.business .type-circle{
        background:linear-gradient(135deg, #7ecbff, #448dff);
    }
...
@section('content')
    <div class="panel search-type-wrap">
        <div class="search-type-grid">
            ...
            <a href="javascript:void(0)" class="type-card new-business">
                <div class="type-circle">
                    <i class="fa-solid fa-city"></i>
                </div>
                <h4>U.S. New Businesses</h4>
            </a>

            <a href="javascript:void(0)" class="type-card consumer">
                <div class="type-circle">
                    <i class="fa-solid fa-house"></i>
                </div>
                <h4>U.S. Consumers + Auto Data</h4>
            </a>

            <a href="javascript:void(0)" class="type-card movers">
                <div class="type-circle">
                    <i class="fa-solid fa-truck-moving"></i>
                </div>
                <h4>U.S. New Movers</h4>
            </a>
        </div>
    </div>
